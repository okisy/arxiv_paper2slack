# settings
keywords_ai = '"Deep Learning" OR "Machine Learning" OR "Neural Network" OR "Graph Neural Network" OR "GNN" OR "Transformer" OR "Representation Learning" OR "Synthetic Data" OR "Data Synthesis"'
